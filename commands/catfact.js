...
module.exports = {
	commands: 'catfact',
	description: 'Give a random cat fact!',
  execute(message, arguments, text) {
    //=======================//
    //===== CAT   FACTS =====//
    //=======================//

    let catfacts = [`A cat’s average lifespan increased by a year over the span of time between 2002 and 2012, according to a study by Banfield Pet Hospital.`,
